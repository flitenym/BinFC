...
namespace Host.StaticClasses
{
    public static class InternalLocalizers
    {
        private const string LOCATION = "Host";
        ...
        static InternalLocalizers()
        {
            ...
            General = new ResourceManagerStringLocalizerFactory(options, new LoggerFactory()).Create("Host.General", LOCATION);
        }
    }
}
